...
struct EditProfileView: View {
    ...
    private var generalSection: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            sectionHeader("General Information", systemImage: "person.crop.circle")
    ...
    private var preferencesSection: some View {
        VStack(alignment: .leading, spacing: 16) {
            sectionHeader("Preferences and Areas", systemImage: "sparkles")
                .padding(.top, 20)
    ...
    private var socialSection: some View {
        VStack(alignment: .leading, spacing: 16) {
            sectionHeader("Social Networks", systemImage: "link")
                .padding(.top, 20)
        ...
        VStack(alignment: .leading, spacing: 6) {
            HStack(spacing: 8) {
                Image(systemName: systemImage)
                    ...
                    .foregroundColor(.primaryDark.opacity(0.85))
